/********************************************************************
* $ID: rtputils.c           Thu 2016-09-29 17:34:57 +0800  lz       *
*                                                                   *
* Description:                                                      *
*                                                                   *
...
unsigned int RtpCreate(unsigned int u32IP, int s32Port, EmRtpPayload emPayload)
{
    ...
    hRtp->u32SSrc = htonl(((struct sockaddr_in *)(void*)(&stIfr.ifr_addr))->sin_addr.s_addr);
...
printf("4\n");
    hRtp->pRtpFixedHdr = (StRtpFixedHdr *)(void*)pSendBuf;
...
{
    int s32NalSize = 0;
    char *pNalBuf=NULL, *pDataEnd=NULL;
    HndRtp hRtp = (HndRtp)u32Rtp;
